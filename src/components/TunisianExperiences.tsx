...
const tunisianExperiences = [
  {
    ...
    guideImage: "/images/tunisia/exp-guide-hassan.jpg",
    location: "Douz, Porte du Sahara",
    duration: "3 jours / 2 nuits",
    price: 280,
    rating: 4.9,
    reviews: 156,
    image: "/images/tunisia/exp-sahara-main.jpg",
    ...
    guide: "Fatma Souissi",
    guideImage: "/images/tunisia/exp-guide-fatma.jpg",
    location: "Île de Djerba",
    duration: "1 journée",
    price: 85,
    rating: 4.8,
    reviews: 94,
    image: "/images/tunisia/exp-djerba-main.jpg",
    ...
    guideImage: "/images/tunisia/exp-guide-salim.jpg",
    location: "Médina de Tunis",
    duration: "4 heures",
    price: 65,
    rating: 4.7,
    reviews: 203,
    image: "/images/tunisia/exp-medina-main.jpg",
  ...
  },
  {
    ...
    guideImage: "/images/tunisia/exp-guide-amina.jpg",
    location: "Tozeur, Oasis de Chebika",
    duration: "2 jours",
    price: 150,
    rating: 4.9,
    reviews: 87,
    image: "/images/tunisia/exp-oasis-main.jpg",
  ...
  },
  {
    ...
    guideImage: "/images/tunisia/exp-guide-youssef.jpg",
    location: "Sidi Bou Saïd",
    duration: "3 heures",
    price: 45,
    rating: 4.8,
    reviews: 145,    image: "/images/tunisia/exp-sidi-bou-said-music.jpg",
  ...
  },
  {
    ...
    guide: "Khadija Hamdi",
    guideImage: "/images/tunisia/exp-guide-khadija.jpg",
    location: "Sousse",
    duration: "5 heures",
    price: 75,
    rating: 4.9,
    reviews: 178,
    image: "/images/tunisia/exp-sousse-cuisine.jpg",
        ...
        >
          {tunisianExperiences.map((experience, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover-lift"
